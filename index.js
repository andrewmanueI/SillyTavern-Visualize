...
function buildDecideMessages(messages, cache) {
    ...
    const developerContent = [
        ...
        '2) {"action":"generate","name":"<short kebab-case slug, 2-4 words>","description":"<2-4 sentences of concrete visual detail mined from the conversation: exact location/room, materials and colors of walls/floors/fixtures, furniture and objects, any specific vehicles or branded items (make, model, body shape, color, manufacturer badge/logo), lighting, time of day/weather, era/style>"}',
        '</output_format>',
        '',
        '<rules>',
        ...
        '- For generate, describe ONLY the physical setting: never mention people, characters, names, pronouns, creatures, or actions, and never include ambient text, signs, or signage; the only permitted logo/mark is one belonging to a specific branded vehicle or object that the scene explicitly establishes.',
        ...
        '- When the scene establishes a specific vehicle or branded object (e.g. "a black Jeep Wrangler parked in the garage"), include it in detail: make, model, body style, color, and its manufacturer badge/logo — this is the ONE case where a logo belongs in the description.',
...
function buildImagePrompt(settingDescription) {
    return [
        ...
        'NO ambient or generic text, signage, posters, letters, or watermarks.',
        'EXCEPTION: when the setting explicitly includes a specific branded object (e.g. a Jeep in a garage), render that object faithfully INCLUDING its manufacturer badge or logo.',
